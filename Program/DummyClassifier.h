...
/// @details The methods here represent different characteristics and behaviours of DummyClassifier which are all dummy functions
/// @author Owen Covach
/// @date 14/4/2023
...
/// @brief A DummyClassifier class (derived class) that inherited from the PhoneOrientation class (Base Class) that has a public access specififers 
/// @details This class overrides the abstract class functions to use for its own class
/// @author Owen Covach
/// @date 14/4/2023
/// </summary>

class DummyClassifier:public PhoneOrientation
{
